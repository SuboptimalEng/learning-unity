...
public class ConditionalHidePropertyDrawer : PropertyDrawer
{
    ...
    bool GetConditionalHideAttributeResult(
    ...
    )
    {
        ...
        if (!property.isArray)
        {
            ...
            if (sourcePropertyValue == null)
            {
                ...
                sourcePropertyValue = property.serializedObject.FindProperty(
                    condHAtt.conditionalSourceField
                );
            }
        }
    ...
    )
    {
        ...
        switch (sourcePropertyValue.propertyType)
        {
            ...
            default:
                Debug.LogError(
                    "Data type of the property used for conditional hiding ["
